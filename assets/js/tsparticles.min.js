  ...
  (function (t) {
    ...
    4: function (t, i, e) {
      ...
      class x {
        static colorToRgb(t) {
          ...
          if ("string" == typeof s.value)
            o =
              s.value === w.randomColorValue
                ? this.getRandomRgbColor()
                : x.stringToRgb(s.value);
          else if (s.value instanceof Array) {
            const t = z.itemFromArray(s.value);
            o = x.colorToRgb({ value: t });
          } else {
            const t = s.value,
        ...
        static stringToAlpha(t) {
          var i;
          return null === (i = x.stringToRgba(t)) || void 0 === i
            ? void 0
            : i.a;
        }
        ...
        static mix(t, i, e, s) {
          let o = t,
            n = i;
          return (
            void 0 === o.r && (o = this.hslToRgb(t)),
            void 0 === n.r && (n = this.hslToRgb(i)),
            {
              b: z.mix(o.b, n.b, e, s),
              g: z.mix(o.g, n.g, e, s),
              r: z.mix(o.r, n.r, e, s),
          ...
          }
          {
            const i = /^#?([a-f\d])([a-f\d])([a-f\d])([a-f\d])?$/i,
              e = t.replace(
                i,
                (t, i, e, s, o) =>
                  i + i + e + e + s + s + (void 0 !== o ? o + o : "")
              ),
              s = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})?$/i.exec(
                e
              );
            return s
              ? {
      ...
      class z {
        ...
        static deepExtend(t, ...i) {
          for (const e of i) {
            ...
            for (const i in e) {
              ...
              t[i] =
                o && Array.isArray(s)
                  ? s.map((e) => this.deepExtend(t[i], e))
                  : this.deepExtend(t[i], s);
            }
          }
          return t;
        }
        static isDivModeEnabled(t, i) {
          return i instanceof Array
            ? i.filter((i) => i.enable && z.isInArray(t, i.mode)).length > 0
            : z.isInArray(t, i.mode);
        }
        ...
        static singleDivModeExecute(t, i) {
          const e = t.ids;
          if (e instanceof Array) for (const s of e) i(s, t);
          else i(e, t);
        }
        static divMode(t, i) {
          if (i && t)
            return t instanceof Array
              ? t.find((t) => z.isInArray(i, t.ids))
              : z.isInArray(i, t.ids)
              ? t
              : void 0;
        }
      ...
      class k {
        init(t) {
          ...
          return s(this, void 0, void 0, function* () {
            const e = t.options;
            if (
              z.isInArray(n.char, e.particles.shape.type) ||
              z.isInArray(n.character, e.particles.shape.type)
            ) {
              const t =
                null !== (i = e.particles.shape.options[n.character]) &&
                void 0 !== i
                  ? i
                  : e.particles.shape.options[n.char];
              if (t instanceof Array) for (const i of t) yield z.loadFont(i);
        ...
        draw(t, i, e) {
          ...
          void 0 === n.text &&
            (n.text =
              o instanceof Array ? z.itemFromArray(o, i.randomIndexData) : o);
          const a = n.text,
            r = s.style,
            l = s.weight,
            c = 2 * Math.round(e),
        ...
        init(t) {
          ...
          return s(this, void 0, void 0, function* () {
            ...
            if (!z.isInArray(n.image, e.type) && !z.isInArray(n.images, e.type))
              return;
            const s =
              null !== (i = e.options[n.images]) && void 0 !== i
                ? i
                : e.options[n.image];
          ...
          return s(this, void 0, void 0, function* () {
            try {
              const e = i.replaceColor
                ? yield z.downloadSvgImage(i.src)
                : yield z.loadImage(i.src);
              this.addImage(t, e);
            } catch (t) {
        ...
        draw(t, i, e) {
          ...
          const a = i.shapeData,
            r =
              null !==
                (o =
                  null !== (s = null == a ? void 0 : a.sides) && void 0 !== s
                    ? s
                    : null == a
                    ? void 0
                    : a.nb_sides) && void 0 !== o
                ...
                : 5,
            l =
              null !== (n = null == a ? void 0 : a.inset) && void 0 !== n
                ? n
                : 2;
          t.moveTo(0, 0 - e);
          for (let i = 0; i < r; i++)
      ...
      class E {
        ...
        static drawLinkLine(t, i, e, s, o, n, a, r, l, c, h) {
          ...
          if (z.getDistance(e, s) <= o) this.drawLine(t, e, s), (d = !0);
            ...
            i &&
              a &&
              (this.drawLine(t, e, i), this.drawLine(t, s, a), (d = !0));
          }
          if (d) {
            if (
              ((t.lineWidth = i),
              r && (t.globalCompositeOperation = "destination-out"),
              (t.strokeStyle = x.getStyleFromRgb(l, c)),
              h.enable)
            ) {
              const i = x.colorToRgb(h.color);
              i &&
                ((t.shadowBlur = h.blur),
                (t.shadowColor = x.getStyleFromRgb(i)));
            }
            t.stroke();
          }
        }
        ...
        static gradient(t, i, e, s) {
          ...
          return (
            h.addColorStop(0, x.getStyleFromHsl(n, s)),
            h.addColorStop(o > 1 ? 1 : o, x.getStyleFromRgb(c, s)),
            h.addColorStop(1, x.getStyleFromHsl(a, s)),
            h
          );
        }
        ...
        static drawParticle(t, i, e, s, o, n, a, r, l) {
          ...
          l.enable &&
            h &&
            ((i.shadowBlur = l.blur),
            (i.shadowColor = x.getStyleFromRgb(h)),
          ...
          (i.lineWidth = d.width),
            e.strokeColor &&
              (i.strokeStyle = x.getStyleFromRgb(
                e.strokeColor,
                e.stroke.opacity
              )),
            e.close && i.closePath(),
      ...
      class I {
        ...
        paint() {
          ...
          this.context &&
            ...
            this.coverColor
              ? this.paintBase(x.getStyleFromRgb(this.coverColor))
              : this.paintBase());
        }
        clear() {
          const t = this.container.options,
          ...
          t.backgroundMask.enable
            ...
            ? this.paintBase(
                x.getStyleFromRgb(this.trailFillColor, 1 / i.length)
              )
            : this.context && E.clear(this.context, this.size);
        }
      ...
      class L {
            ...
            switch (e.opacity.status) {
              case r.increasing:
                e.opacity.value >= e.particlesOptions.opacity.value
                  ? (e.opacity.status = r.decreasing)
                  : (e.opacity.value += (e.opacity.velocity || 0) * s);
                break;
              case r.decreasing:
                e.opacity.value <=
                e.particlesOptions.opacity.animation.minimumValue
                  ? (e.opacity.status = r.increasing)
                  : (e.opacity.value -= (e.opacity.velocity || 0) * s);
            }
        ...
        updateSize(t) {
          ...
          if (r.enable) {
            switch (o.size.status) {
              case l.increasing:
                o.size.value >=
                (null !== (i = o.sizeValue) && void 0 !== i
                  ? i
                  : e.retina.sizeValue)
                  ? (o.size.status = l.decreasing)
                  : (o.size.value += (o.size.velocity || 0) * n);
                break;
              case l.decreasing:
                o.size.value <= r.minimumValue
                  ? (o.size.status = l.increasing)
                  : (o.size.value -= (o.size.velocity || 0) * n);
            }
            switch (r.destroy) {
              case c.max:
                ...
                break;
              case c.min:
                o.size.value <= r.minimumValue * e.retina.pixelRatio &&
                  o.destroy();
            }
        ...
        fixOutOfCanvasPosition() {
          ...
          if (
            ...
            z.isPointInside(i.position, t.canvas.size, e) ||
              t.particles.remove(i);
          } else {
            const t = i.size.value,
              e = z.calculateBounds(i.position, t);
            e.left > o.width - i.offset.x
              ? ((i.position.x = n.left),
                s || (i.position.y = Math.random() * o.height))
              : e.right < -i.offset.x &&
                ((i.position.x = n.right),
                s || (i.position.y = Math.random() * o.height)),
              e.top > o.height - i.offset.y
                ? (s || (i.position.x = Math.random() * o.width),
                  (i.position.y = n.top))
                : e.bottom < -i.offset.y &&
                  (s || (i.position.x = Math.random() * o.width),
                  (i.position.y = n.bottom));
          }
        }
        updateOutMode(t) {
        ...
        updateBounce(t) {
          ...
          for (const [, o] of i.plugins)
            if (
              (void 0 !== o.particleBounce && (s = o.particleBounce(e, t)), s)
            )
              break;
          if (!s) {
      ...
      class _ {
        ...
        load(t) {
          void 0 !== t &&
            (void 0 !== t.color && (this.color = V.create(this.color, t.color)),
            void 0 !== t.enable && (this.enable = t.enable),
      ...
      class Q {
        ...
        get image() {
          var t;
          return null !== (t = this.options[n.image]) && void 0 !== t
            ? t
            : this.options[n.images];
        }
        set image(t) {
        ...
        get character() {
          var t;
          return null !== (t = this.options[n.character]) && void 0 !== t
            ? t
            : this.options[n.char];
        }
        set character(t) {
        ...
        get polygon() {
          var t;
          return null !== (t = this.options[n.polygon]) && void 0 !== t
            ? t
            : this.options[n.star];
        }
        set polygon(t) {
          ...
          void 0 !== t &&
            (t instanceof Array
              ? (this.options[i] instanceof Array ||
                  ((this.options[i] = []),
                  (this.options[e] && !s) || (this.options[e] = [])),
                (this.options[i] = z.deepExtend(
                  null !== (o = this.options[i]) && void 0 !== o ? o : [],
                  t
                )),
                (this.options[e] && !s) ||
                  (this.options[e] = z.deepExtend(
        ...
        load(t) {
          ...
          void 0 !== h &&
            (h instanceof Array
              ...
              : (this.stroke instanceof Array && (this.stroke = new ot()),
                this.stroke.load(h)));
        }
      }
      class dt {
        constructor(t, i, e) {
          ...
          const C = t.options,
            O = new ht();
          if (
            (O.load(C.particles), void 0 !== (null == e ? void 0 : e.shape))
          ) {
            const t =
              null !== (s = e.shape.type) && void 0 !== s ? s : O.shape.type;
            this.shape = t instanceof Array ? z.itemFromArray(t) : t;
            const i = new Q();
            if ((i.load(e.shape), void 0 !== this.shape)) {
              const t = i.options[this.shape];
              void 0 !== t &&
                ((this.shapeData = z.deepExtend(
                  {},
                  t instanceof Array ? z.itemFromArray(t) : t
                )),
                (this.fill =
                  null !==
                    (a =
                      null === (o = this.shapeData) || void 0 === o
                        ? void 0
                        : o.fill) && void 0 !== a
                    ? a
                    : this.fill),
            ...
            i &&
              ((this.shapeData = z.deepExtend(
                {},
                i instanceof Array ? z.itemFromArray(i) : i
              )),
              (this.fill =
                null !==
                  (p =
          ...
          (this.noiseDelay =
            1e3 *
            (T.random.enable
              ? z.randomInRange(T.random.minimumValue, T.value)
              : T.value)),
          ...
          if (
            ((this.size = {
              value:
                I && void 0 !== this.randomMinimumSize
                  ? z.randomInRange(this.randomMinimumSize, E)
                  : E,
            }),
            ...
            this.particlesOptions.rotate.direction === h.random)
          ) {
          ...
          if (
            (H ||
              ((H = M.getShapeDrawer(this.shape)),
              H && t.drawers.set(this.shape, H)),
            this.shape === n.image || this.shape === n.images)
          ) {
            const i = H,
              ...
              n =
                e instanceof Array ? e.filter((t) => t.src === o.source)[0] : e,
              a = this.getColor();
            if (
              void 0 !== (null == o ? void 0 : o.svgData) &&
              n.replaceColor &&
              a
            ) {
              ...
              (this.image = {
                ...
                replaceColor:
                  null !== (k = n.replaceColor) && void 0 !== k
                    ? k
                    : n.replace_color,
                source: n.src,
              }),
                ...
                r.addEventListener("error", () => {
                  e.revokeObjectURL(s),
                    z.loadImage(n.src).then((t) => {
                      this.image &&
                        ((o.element = t.element), (this.image.loaded = !0));
                    });
                }),
                (r.src = s);
            } else
              this.image = {
                ...
                ratio: n.width / n.height,
                replaceColor:
                  null !== (P = n.replaceColor) && void 0 !== P
                    ? P
                    : n.replace_color,
                source: n.src,
              };
        ...
        draw(t) {
          var i;
          !1 !==
            (null === (i = this.image) || void 0 === i ? void 0 : i.loaded) &&
        ...
        calcPosition(t, i) {
          ...
          const o = {
              ...
              y:
                null !== (s = null == i ? void 0 : i.y) && void 0 !== s
                  ? s
                  : Math.random() * t.canvas.size.height,
            },
            n = this.particlesOptions.move.outMode;
          return (
            (z.isInArray(n, d.bounce) || z.isInArray(n, d.bounceHorizontal)) &&
              (o.x > t.canvas.size.width - 2 * this.size.value
                ? (o.x -= this.size.value)
                : o.x < 2 * this.size.value && (o.x += this.size.value)),
            (z.isInArray(n, d.bounce) || z.isInArray(n, d.bounceVertical)) &&
              (o.y > t.canvas.size.height - 2 * this.size.value
                ? (o.y -= this.size.value)
                : o.y < 2 * this.size.value && (o.y += this.size.value)),
            o
          );
        }
        calculateVelocity() {
          ...
          return (
            e.straight
              ? ((i.horizontal = t.x),
                (i.vertical = t.y),
                e.random &&
                  ((i.horizontal += z.randomInRange(n.left, n.right) / 2),
                  (i.vertical += z.randomInRange(n.left, n.right) / 2)))
              : ((i.horizontal = t.x + z.randomInRange(n.left, n.right) / 2),
                (i.vertical = t.y + z.randomInRange(n.left, n.right) / 2)),
            i
          );
        }
      }
      ...
      class pt {
        ...
        subdivide() {
          ...
          (this.northEast = new pt(new vt(t, i, e / 2, s / 2), o)),
            ...
            (this.southWest = new pt(
              new vt(t + e / 2, i + s / 2, e / 2, s / 2),
              o
            )),
            (this.divided = !0);
        }
      ...
      class ft {
        ...
        interact() {
          ...
          if (
            ...
            e.interactivity.status === w.mouseMoveEvent
          ) {
                ...
                if (c > 0) {
                  const s =
                    null !== (t = a.color) && void 0 !== t
                      ? t
                      : n.particlesOptions.links.color;
                  let r;
                  if (
                    (e.particles.grabLineColor ||
                      (e.particles.grabLineColor =
                        s === w.randomColorValue ||
                        (null === (i = s) || void 0 === i
                          ? void 0
                          : i.value) === w.randomColorValue
                          ? w.randomColorValue
                          : x.colorToRgb(s)),
                    (r =
                      e.particles.grabLineColor === w.randomColorValue
                        ? x.getRandomRgbColor()
                        : e.particles.grabLineColor),
                    void 0 === r)
                  )
      ...
      class gt {
        ...
        isEnabled() {
          ...
          if (
            !(
              n ||
              (s.onHover.enable && e.position) ||
              (s.onClick.enable && e.clickPosition)
            )
          )
            return !1;
        ...
        interact() {
          const t = this.container,
            ...
            l = s.onClick.mode,
            c = s.onDiv;
          e && o && z.isInArray(a.repulse, n)
            ? this.hoverRepulse()
            : r && z.isInArray(m.repulse, l)
            ? this.clickRepulse()
            : z.divModeExecute(p.repulse, c, (t, i) =>
                this.singleDivRepulse(t, i)
              );
        }
          ...
          for (const e of a) {
            ...
            if (
              ...
              (v === d.bounceVertical || t.horizontal) && (e.position.x = m.x),
                (v === d.bounceHorizontal || t.vertical) &&
                  (e.position.y = m.y);
        ...
        processClickRepulse(t, i, e, s) {
          ...
          if (
            ...
            r !== d.bounceVertical &&
              (i.x + t.size.value > o.canvas.size.width ||
                i.x - t.size.value < 0) &&
              (t.velocity.horizontal *= -1),
              r !== d.bounceHorizontal &&
                (i.y + t.size.value > o.canvas.size.height ||
                  i.y - t.size.value < 0) &&
                (t.velocity.vertical *= -1);
          }
        }
      }
      !(function (t) {
      ...
      class bt {
        ...
        interact() {
          const t = this.container.options.interactivity.events,
            ...
            r = e.mode,
            l = t.onDiv;
          s && z.isInArray(a.bubble, o)
            ? this.hoverBubble()
            : n && z.isInArray(m.bubble, r)
            ? this.clickBubble()
            : z.divModeExecute(p.bubble, l, (t, i) =>
                this.singleDivHover(t, i)
              );
        }
        singleDivHover(t, i) {
          const e = this.container,
          ...
          for (const i of l.filter((t) => r.contains(t.getPosition()))) {
            ...
            const s = e.options.interactivity.modes.bubble.divs,
              o = z.divMode(s, t);
            (i.bubble.divId && i.bubble.divId === t) ||
              (this.reset(i, !0), (i.bubble.divId = t)),
        ...
        hoverBubble() {
          ...
          for (const e of s) {
            ...
            o <= t.retina.bubbleModeDistance
              ? n >= 0 &&
                t.interactivity.status === w.mouseMoveEvent &&
                (this.hoverBubbleSize(e, n),
                this.hoverBubbleOpacity(e, n),
                this.hoverBubbleColor(e))
              : this.reset(e),
        ...
        interact(t) {
          ...
          for (const i of h) {
            ...
            if (u > 0) {
              ...
              let o =
                void 0 !== s.id
                  ? e.particles.linksColors[s.id]
                  : e.particles.linksColor;
              if (!o) {
                const t = s.color,
                  i = "string" == typeof t ? t : t.value;
                (o =
                  i === w.randomColorValue
                    ? s.consent
                      ? x.colorToRgb({ value: i })
                      : s.blink
                      ? w.randomColorValue
                      : w.midColorValue
                    : x.colorToRgb({ value: i })),
                  void 0 !== s.id
                    ? (e.particles.linksColors[s.id] = o)
      ...
      class Pt {
        ...
        static collisionVelocity(t, i, e, s) {
          return {
            horizontal:
              (t.horizontal * (e - s)) / (e + s) +
              (2 * i.horizontal * s) / (e + s),
            vertical: t.vertical,
          };
        }
        static bounce(t, i) {
        ...
        static destroy(t, i) {
          void 0 === t.size.value && void 0 !== i.size.value
            ? t.destroy()
            : void 0 !== t.size.value && void 0 === i.size.value
            ? i.destroy()
            : void 0 !== t.size.value &&
              void 0 !== i.size.value &&
              (t.size.value >= i.size.value ? i.destroy() : t.destroy());
        }
        ...
        interact(t) {
          ...
          for (const o of s) {
            if (
              t === o ||
              !o.particlesOptions.collisions.enable ||
              t.particlesOptions.collisions.mode !==
                o.particlesOptions.collisions.mode
            )
              continue;
            const s = o.getPosition(),
              n = z.getDistance(e, s),
              a = i.retina.sizeValue;
            n <= Pt.getRadius(t, a) + Pt.getRadius(o, a) &&
              this.resolveCollision(t, o);
          }
        }
        ...
        absorb(t, i) {
          ...
          if (void 0 === t.size.value && void 0 !== i.size.value) t.destroy();
            ...
            if (t.size.value >= i.size.value) {
              const o =
                z.clamp(t.size.value / i.size.value, 0, i.size.value) * s;
              (t.size.value += o),
                (i.size.value -= o),
                i.size.value <= e.retina.pixelRatio &&
                  ((i.size.value = 0), i.destroy());
            } else {
              const o =
                z.clamp(i.size.value / t.size.value, 0, t.size.value) * s;
              (t.size.value -= o),
                (i.size.value += o),
                t.size.value <= e.retina.pixelRatio &&
      ...
      class Mt {
        ...
        interact(t, i) {
          ...
          const a = n.stages[t.infectionStage],
            ...
            c = t.getPosition(),
            h =
              null !== (e = a.infectedStage) && void 0 !== e
                ? e
                : t.infectionStage,
            d = o.particles.quadTree
              .query(new yt(c.x, c.y, l))
              .filter(
                (i) =>
            ...
            if (Math.random() < u / v)
              if (void 0 === i.infectionStage) i.startInfection(h);
                ...
                const e = n.stages[i.infectionStage],
                  o =
                    null !== (s = null == e ? void 0 : e.infectedStage) &&
                    void 0 !== s
                      ? s
                      : i.infectionStage;
        ...
        update(t) {
          ...
          for (const s of this.array) {
            ...
            s.destroyed || s.update(t),
              s.destroyed
                ? e.push(s)
                : this.quadTree.insert(new mt(s.getPosition(), s));
          }
      ...
      class Ct {
        ...
        init() {
          const t = this.container,
            i = t.options;
          i.detectRetina
            ? (this.pixelRatio = z.isSsr() ? 1 : window.devicePixelRatio)
            : (this.pixelRatio = 1);
        ...
        initParticle(t) {
          ...
          (t.linksDistance = i.links.distance * e),
            ...
            "boolean" != typeof i.size.random &&
              (t.randomMinimumSize = i.size.random.minimumValue * e),
          ...
          void 0 !== t &&
            ...
            void 0 !== t.color &&
              (t.color instanceof Array
                ? (this.color = t.color.map((t) => V.create(void 0, t)))
          ...
          void 0 !== o && (this.detectsOn = o),
            ...
            !0 ===
              ...
              (this.events.onHover.mode instanceof Array
                ? this.events.onHover.mode.indexOf(a.slow) < 0 &&
                  this.events.onHover.mode.push(a.slow)
                : this.events.onHover.mode !== a.slow &&
      ...
      class ei {
        ...
        manageListeners(t) {
          ...
          o &&
            ...
            (ei.manageListener(o, w.mouseMoveEvent, this.mouseMoveHandler, t),
            ei.manageListener(o, w.touchStartEvent, this.touchStartHandler, t),
            ei.manageListener(o, w.touchMoveEvent, this.touchMoveHandler, t),
            e.interactivity.events.onClick.enable ||
              ei.manageListener(o, w.touchEndEvent, this.touchEndHandler, t),
            ei.manageListener(o, w.mouseLeaveEvent, this.mouseLeaveHandler, t),
            ei.manageListener(
              o,
              w.touchCancelEvent,
            ...
            e.interactivity.events.onClick.enable &&
              ...
              ei.manageListener(o, w.mouseUpEvent, this.mouseUpHandler, t)),
            e.interactivity.events.resize &&
              ei.manageListener(window, w.resizeEvent, this.resizeHandler, t),
            document &&
              ei.manageListener(
                document,
                w.visibilityChangeEvent,
                this.visibilityChangeHandler,
                t,
                !1
              );
        ...
        mouseTouchMove(t) {
          ...
          if (t.type.startsWith("mouse")) {
            ...
            if (
              void 0 ===
              (null === (i = o.interactivity) || void 0 === i
                ? void 0
                : i.element)
            )
              return;
            if (o.interactivity.element === window) {
              ...
              if (t && i) {
                ...
                a = { x: e.offsetX || e.clientX, y: e.offsetY || e.clientY };
            } else
              e.target === o.canvas.element &&
                (a = { x: e.offsetX || e.clientX, y: e.offsetY || e.clientY });
          } else {
            ...
            a = {
              ...
              y:
                o.clientY -
                (null !== (s = null == n ? void 0 : n.top) && void 0 !== s
                  ? s
                  : 0),
            };
          }
        ...
        handleClickMode(t) {
          ...
          switch (t) {
            case m.push:
              s > 0 &&
                (e.particles.move.enable || 1 === s
                  ? i.particles.push(s, i.interactivity.mouse)
                  : s > 1 && i.particles.push(s));
              break;
            case m.remove:
      ...
      class si {
        ...
        pause() {
          if (
            (void 0 !== this.drawAnimationFrame &&
              (z.cancelAnimation(this.drawAnimationFrame),
        ...
        draw() {
          this.drawAnimationFrame = z.animate((t) => {
            var i;
            return null === (i = this.drawer) || void 0 === i
              ? void 0
              : i.nextFrame(t);
          });
        }
        ...
        densityAutoParticles() {
          ...
          o < s
            ? this.particles.push(Math.abs(s - o))
            : o > s && this.particles.removeQuantity(o - s);
        }
        destroy() {
          this.stop(),
            this.canvas.destroy(),
        ...
        exportImage(t, i, e) {
          ...
          return null === (s = this.canvas.element) || void 0 === s
            ? void 0
            : s.toBlob(t, null != i ? i : "image/png", e);
        }
        exportConfiguration() {
        ...
        static set(t, i, e) {
          return s(this, void 0, void 0, function* () {
            ...
            if ("canvas" === i.tagName) (n = i), (a = !1);
              ...
              t.length
                ? ((n = t[0]),
                  n.className || (n.className = w.canvasClass),
                  (a = !1))
                : ((a = !0),
                  (n = document.createElement("canvas")),
                  (n.className = w.canvasClass),
                  (n.style.width = "100%"),
                  (n.style.height = "100%"),
                  i.appendChild(n));
            }
            const r = new si(t, e);
            return (
              o >= 0 ? s.splice(o, 0, r) : s.push(r),
              r.canvas.loadCanvas(n, a),
              yield r.start(),
              r
            );
          });
      ...
      class ai {
        constructor(t, i, e, s) {
          ...
          const r =
              "boolean" == typeof e.size.random
                ? e.size.random
                : e.size.random.enable,
            l =
              "boolean" == typeof e.size.random
                ? 1
                : e.size.random.minimumValue;
          ...
          const h = "string" == typeof e.color ? { value: e.color } : e.color;
          (this.color =
            null !== (o = x.colorToRgb(h)) && void 0 !== o
              ? o
              : { b: 0, g: 0, r: 0 }),
            (this.position =
        ...
        attract(t) {
          ...
          if (o < this.size + t.size.value) {
            ...
            this.size > t.size.value && o < this.size - t.size.value
              ? t.destroy()
              : ((t.size.value -= i),
        ...
        resize() {
          ...
          this.position =
            t && z.isPointInside(t, this.container.canvas.size)
              ? t
              : this.calcPosition();
        }
        draw(t) {
      ...
      class di {
        ...
        init(t) {
          ...
          t.absorbers &&
            (t.absorbers instanceof Array
              ...
              : (this.absorbers instanceof Array && (this.absorbers = new ci()),
          ...
          if (
            (s &&
              (s instanceof Array
                ? (this.interactivityAbsorbers = s.map((t) => {
                    const i = new ci();
                    return i.load(t), i;
                  }))
                : (this.interactivityAbsorbers instanceof Array &&
                    (this.interactivityAbsorbers = new ci()),
        ...
        handleClickMode(t) {
          ...
          if (t === hi.absorber) {
            let t;
            s instanceof Array
              ? s.length > 0 && (t = z.itemFromArray(s))
              : (t = s);
            const o =
                null != t ? t : e instanceof Array ? z.itemFromArray(e) : e,
      ...
      const ui = new (class {
        ...
        loadOptions(t, i) {
          ...
          (null == i ? void 0 : i.absorbers) &&
            ((null == i ? void 0 : i.absorbers) instanceof Array
              ? (o.absorbers =
                  null == i
                    ? void 0
                    : i.absorbers.map((t) => {
              ...
              : ((o.absorbers instanceof Array || void 0 === o.absorbers) &&
                  (o.absorbers = new ci()),
                o.absorbers.load(null == i ? void 0 : i.absorbers)));
          const n =
            null ===
              (s =
          ...
          n &&
            (n instanceof Array
              ? (o.interactivity.modes.absorbers = n.map((t) => {
                  const i = new ci();
                  return i.load(t), i;
                }))
              : ((o.interactivity.modes.absorbers instanceof Array ||
                  void 0 === o.interactivity.modes.absorbers) &&
                  (o.interactivity.modes.absorbers = new ci()),
                o.interactivity.modes.absorbers.load(n)));
        }
      })();
      var vi, pi;
      !(function (t) {
          ...
          void 0 === r && (r = {}),
            ...
            (this.size =
              null !== (n = this.emitterOptions.size) && void 0 !== n
                ...
                : (() => {
                    const t = new mi();
                    return t.load({ height: 0, mode: vi.percent, width: 0 }), t;
                  })()),
            (this.lifeCount =
      ...
      class bi {
        ...
        load(t) {
          void 0 !== t &&
            (void 0 !== t.size &&
              (void 0 === this.size && (this.size = new mi()),
              this.size.load(t.size)),
            void 0 !== t.direction && (this.direction = t.direction),
            this.life.load(t.life),
            void 0 !== t.particles &&
              (this.particles = z.deepExtend({}, t.particles)),
        ...
        init(t) {
          ...
          t.emitters &&
            (t.emitters instanceof Array
              ...
              : (this.emitters instanceof Array && (this.emitters = new bi()),
          ...
          if (
            (s &&
              (s instanceof Array
                ? (this.interactivityEmitters = s.map((t) => {
                    const i = new bi();
                    return i.load(t), i;
                  }))
                : (this.interactivityEmitters instanceof Array &&
                    (this.interactivityEmitters = new bi()),
                  this.interactivityEmitters.load(s))),
      ...
      const xi = new (class {
        ...
        loadOptions(t, i) {
          ...
          (null == i ? void 0 : i.emitters) &&
            ((null == i ? void 0 : i.emitters) instanceof Array
              ? (o.emitters =
                  null == i
                    ? void 0
                    : i.emitters.map((t) => {
              ...
              : ((o.emitters instanceof Array || void 0 === o.emitters) &&
                  (o.emitters = new bi()),
                o.emitters.load(null == i ? void 0 : i.emitters)));
          const n =
            null ===
              (s =
                null === (e = null == i ? void 0 : i.interactivity) ||
          ...
          n &&
            (n instanceof Array
              ? (o.interactivity.modes.emitters = n.map((t) => {
                  const i = new bi();
                  return i.load(t), i;
                }))
              : ((o.interactivity.modes.emitters instanceof Array ||
                  void 0 === o.interactivity.modes.emitters) &&
                  (o.interactivity.modes.emitters = new bi()),
                o.interactivity.modes.emitters.load(n)));
        }
      })();
      var zi, ki, Pi;
      !(function (t) {
        ...
        load(t) {
          ...
          void 0 !== t &&
            ...
            "string" == typeof this.color.value &&
              (this.opacity =
                null !== (i = x.stringToAlpha(this.color.value)) && void 0 !== i
                  ? i
                  : this.opacity),
            void 0 !== t.opacity && (this.opacity = t.opacity),
            void 0 !== t.width && (this.width = t.width));
      ...
      class Ri {
        ...
        static drawPolygonMaskPath(t, i, e, s) {
          ...
          o &&
            ((t.strokeStyle = x.getStyleFromRgb(o, e.opacity)),
            (t.lineWidth = e.width),
            t.stroke(i));
        }
        static parsePaths(t, i, e) {
          ...
          for (const o of t) {
            ...
            for (let o = 0; o < n; o++) {
              ...
              s.push({ x: a.x * i + e.x, y: a.y * i + e.y });
            }
          }
          return s;
        }
        ...
        particlesInitialization() {
          ...
          return (
            !(
              !t.enable ||
              t.type !== zi.inline ||
              (t.inline.arrangement !== ki.onePerPoint &&
                t.inline.arrangement !== ki.perPoint)
            ) && (this.drawPoints(), !0)
          );
        }
        ...
        particleBounce(t) {
          ...
          if (i.enable && i.type !== zi.none && i.type !== zi.inline) {
            ...
            if (
              z.getDistance(t.initialPosition, t.getPosition()) >
              this.polygonMaskMoveRadius
            )
              return Ri.polygonBounce(t), !0;
          }
        ...
        draw(t) {
          ...
          for (const i of this.paths) {
            ...
            t &&
              (n && e && this.offset
                ? Ri.drawPolygonMaskPath(t, e, s.stroke, this.offset)
                : o && Ri.drawPolygonMask(t, o, s.stroke));
          }
        }
        ...
        parseSvgPath(t, i) {
          ...
          (this.dimension.width =
            ...
            (this.dimension.height =
              parseFloat(
                null !== (s = c.getAttribute("height")) && void 0 !== s
                  ? s
                  : "0"
              ) * u);
          const v =
            null !== (o = r.position) && void 0 !== o ? o : { x: 50, y: 50 };
          return (
            (this.offset = {
              x:
                (a.canvas.size.width * v.x) / (100 * d) -
                this.dimension.width / 2,
              y:
                (a.canvas.size.height * v.y) / (100 * d) -
        ...
        getEquidistantPointByIndex(t) {
          ...
          return {
            x:
              (null !== (e = null == h ? void 0 : h.x) && void 0 !== e
                ? e
                : 0) *
                c.scale +
              (null !==
                (o =
                  null === (s = this.offset) || void 0 === s ? void 0 : s.x) &&
              void 0 !== o
                ? o
                : 0),
            y:
              (null !== (n = null == h ? void 0 : h.y) && void 0 !== n
                ? n
                : 0) *
                c.scale +
              (null !==
      ...
      const Ei = new (class {
        ...
        needsPlugin(t) {
          ...
          return null !==
            ...
            ? e
            : void 0 !==
                (null === (s = null == t ? void 0 : t.polygon) || void 0 === s
                  ? void 0
                  : s.type) && t.polygon.type !== zi.none;
        }
        loadOptions(t, i) {
